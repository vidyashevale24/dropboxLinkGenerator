...
<body>
	<div class="container">
		...
		<hr>
		<footer class="text-center">&copy; Dropbox Sharable Links</footer>
	</div>
						...
						$.ajax({
							...
							success: function (data) {
								...
								if($.isArray(data)){
									...
									if(fileListFail != ''){
										$('#failLinks').show();
										$("#failLinks").html("<div class='panel-body'><b>Unable to create sharable links for below folder(s):</b><ul style='list-style:none;'>" + fileListFail + "</ul></div>");
									}
								}else{
